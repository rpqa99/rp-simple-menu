...
/**
 * Simple RP Menu en Translation
 *
 * Returns an array with the string to be translated (as passed to `Craft::t('simplerpmenu', '...')`) as
 ...
 */
return [
    'Simple RP Menu plugin loaded' => 'Simple RP Menu plugin loaded',
];
