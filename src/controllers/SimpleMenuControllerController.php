 ...
 * @since     1.0.0
 */
class SimpleMenuControllerController extends Controller
{
     ...
     * e.g.: actions/simple-rp-menu/simple-menu-controller
     *
     * @return mixed
     */
    public function actionIndex()
    {
        $result = 'Welcome to the SimpleMenuControllerController actionIndex() method';
     ...
     * e.g.: actions/simple-rp-menu/simple-menu-controller/do-something
     *
     * @return mixed
     */
    public function actionDoSomething()
    {
        $result = 'Welcome to the SimpleMenuControllerController actionDoSomething() method';
